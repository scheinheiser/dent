...
module Parser = struct
  ...
  and parse_pattern (l : Lexer.t) : located_pattern Lexer.result =
    ...
    | s, TTYPE -> parse_pbop l (s, PTypeLit PUni)
    | pos, tok ->
      Lexer.make_err
        ( Some pos,
  ...
  and parse_binding (l : Lexer.t) ~(is_imp : bool) (s : Location.t)
  ...
  and parse_lam (l : Lexer.t) (om : operator_map) (s : Location.t) :
    ...
    let* _ =
      Lexer.consume l ARROW "Expected '->' or '→' after lambda arguments."
    in
